...
/**
 * 默认主题 · 前台页面数据（分类与公开接口，本主题独立维护）
 */

/** @var int */
const DEFAULT_THEME_CATEGORY_VISIBLE_LIMIT = 15;

/**
 * @return int
 */
function default_theme_category_visible_limit()
{
    return DEFAULT_THEME_CATEGORY_VISIBLE_LIMIT;
}

/**
 * @return array{categoryNames: array<string, string>, apiData: array}
 */
function default_theme_page_payload()
{
